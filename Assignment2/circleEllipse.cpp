...
bool generateEllipse(GVector centrePoint, double radiusA, double radiusB, int numU, Curve& curve)
{
    double r1, r2, x, y, z=20;
...
{  
    ofstream MyFile("C:/gnuplot/circeEllipse.dat");
    cout<<"check"<<endl;
    cout<<c1.size()<<endl;
    cout<<c2.size()<<endl;
    if (c1.size() != c2.size())
...
int main(int argc, char** argv)
{
    ...
    generateEllipse(GVector{ 0.0,0.0,0.0 }, r1, r2, 100, ellipse );
